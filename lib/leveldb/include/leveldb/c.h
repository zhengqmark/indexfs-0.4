...
extern const char* leveldb_iter_internalvalue(const leveldb_iterator_t*, size_t* vlen);
...
#endif
#if defined(PVFS)
extern leveldb_options_t* leveldb_options_create_with_pvfs_env(
                int buffer_size);
#endif
#endif
...
extern void leveldb_options_set_max_sst_file_size(leveldb_options_t*, int);
extern void leveldb_options_set_level_zero_factor(leveldb_options_t*, double);
extern void leveldb_options_set_level_factor(leveldb_options_t*, double);
extern void leveldb_options_disable_compaction(leveldb_options_t*);
...
#endif
#if defined(PVFS)
extern leveldb_env_t* leveldb_create_pvfs_env(int buffer_size);
#endif
#endif
...
extern leveldb_tablebuilder_t* leveldb_tablebuilder_create(
    ...
    leveldb_env_t* env,
    char** errptr);
extern leveldb_tablebuilder_t* leveldb_tablebuilder_create_with_sanitization(
    const leveldb_options_t* options,
    const char* name,
    leveldb_env_t* env,
    char** errptr);
