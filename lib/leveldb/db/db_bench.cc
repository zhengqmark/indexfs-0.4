...
static const char* FLAGS_env_name = "";

namespace leveldb {

static Env* env_ = NULL;
...
int main(int argc, char** argv) {
  ...
  if (strncmp(FLAGS_env_name, "hdfs", 4) == 0) {
    leveldb::env_ = leveldb::Env::HDFSEnv(NULL, 8020);
  } else
  if (strncmp(FLAGS_env_name, "pvfs", 4) == 0) {
    leveldb::env_ = leveldb::Env::PVFSEnv();
  } else {
    leveldb::env_ = leveldb::Env::Default();
  }
